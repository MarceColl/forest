...
I have a tendency when <L name="programming" from="ego-in-programming" /> to search for novel solutions to my problems instead of investigating what already exists. I think this has two main roots
