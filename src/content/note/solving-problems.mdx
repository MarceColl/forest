...
In order to help me tackle this I'm trying to work more and more in solving problems with <L name="forth" /> since it seems that it helps me reduce the scope into only whatever problem I had at the start.

An example of this reduced scope is my expense tracking program: <L name="project-money" />
