...
Internally this is stored as a float variable named `alpha` computed like so:
$$
\alpha = \mathrm{ra_{h}} + \frac{\mathrm{ra_{m}}}{60} + \frac{\mathrm{ra_{s}}}{3600}
$$

In this case it gives a value of $21.649502$.
